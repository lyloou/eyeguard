...
<sub>休息弹窗（浅色）</sub><br/>
<img src="./Doc/pic-rest-light.png" width="360" alt="休息弹窗（浅色）"/>
</td>
<td align="center" valign="top" width="50%">
<sub>休息弹窗（深色）</sub><br/>
<img src="./Doc/pic-rest-dark.png" width="360" alt="休息弹窗（深色）"/>
</td>
</tr>
<tr>
<td align="center" valign="top" width="50%">
<sub>设置（浅色）</sub><br/>
<img src="./Doc/pic-setting-light.png" width="360" alt="设置（浅色）"/>
</td>
<td align="center" valign="top" width="50%">
<sub>设置（深色）</sub><br/>
<img src="./Doc/pic-setting-dark.png" width="360" alt="设置（深色）"/>
</td>
</tr>
<tr>
<td align="center" valign="top" width="50%">
<sub>统计（浅色）</sub><br/>
<img src="./Doc/pic-statistics-light.png" width="360" alt="统计（浅色）"/>
</td>
<td align="center" valign="top" width="50%">
<sub>统计（深色）</sub><br/>
<img src="./Doc/pic-statistics-dark.png" width="360" alt="统计（深色）"/>
</td>
</tr>
<tr>
<td align="center" valign="top" width="50%">
<sub>关于 EyeGuard</sub><br/>
<img src="./Doc/pic-about.png" width="360" alt="关于 EyeGuard"/>
</td>
<td align="center" valign="top" width="50%">
<sub>状态栏菜单</sub><br/>
<img src="./Doc/pic-menu.png" width="360" alt="状态栏菜单"/>
</td>
</tr>
</table>
...
| 音效提示 | 工作/休息开始时播放系统音效 |
| 全局快捷键 | 默认 `⌘⇧P` 计时（空闲开始 / 工作暂停 / 暂停继续）、`⌘⇧X` 立即休息；可在设置中修改或关闭 |
...
| 快捷键 | 行为 |
|--------|------|
| `⌘⇧P`（默认，可改） | **计时**：空闲时开始工作；工作中暂停；已暂停则继续。休息中不响应。 |
| `⌘⇧X`（默认，可改） | **立即休息**（工作中或已暂停时进入休息） |
| （清除后） | 对应功能不再有全局快捷键，仍可用菜单与 CLI |

在 **Settings → SHORTCUTS** 中点击组合框左侧区域录制组合键，右侧 **×** 可关闭该快捷键。
